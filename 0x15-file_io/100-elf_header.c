...
/**
 * print_magic_elf - Prints the magic nums of an ELF.
 * @e_ident: A pointer to an array containing the ELF magic numbers.
 *
...
/**
 * print_version_elf - Prints the version of an ELF header.
...
/**
 * print_osabi_elf - Prints the OS/ABI of an ELF header.
 * @e_ident: A pointer to an array containing the ELF version.
 */
...
int main(int __attribute__((__unused__)) argc, char *argv[])
{
	...
	printf("ELF Header:\n");
	print_magic_elf(header->e_ident);
